...
///  @see `-[IVSPlayerDelegate player:didChangeSyncTime:]`
...
/// An array of string values that represent channel features or capabilities.  These values
/// are defined by IVS.
@property (nonatomic, readonly) NSArray<NSString *> *channelMetadata;
